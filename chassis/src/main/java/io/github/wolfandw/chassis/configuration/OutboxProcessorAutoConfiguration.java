...
public class OutboxProcessorAutoConfiguration {
    @Bean
    public OutboxProcessorService outboxProcessorService(WebClient scheduleWebClient, OutboxRepository outboxRepository) {
        return new OutboxProcessorServiceImpl(scheduleWebClient, outboxRepository);
    }
