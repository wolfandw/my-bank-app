...
public class AccountsClientStubContractTest {
    @MockitoBean
    ...
    void changeUserDataTest() {
        ...
        webTestClient
            .post()
            .uri(uriBuilder -> buildUri(uriBuilder, "user", "User", LocalDate.of(1999, 1, 1)))
    ...
    private URI buildUri(UriBuilder uriBuilder, String login, String name, LocalDate birthdate) {
        return uriBuilder
                .scheme("http")
                .host("localhost")
                .port("8083")
